...
const CreateStoryScreen = ({ route, navigation }) => {
  ...
  const formComponents = [<TitleFormComponent story={story} />, <FullStoryFormComponent story={story} />, <UploadFormComponent story={story} />, <VisualizeFormComponent story={story} />, <AtGlanceComponent story={story} />, <SuccessComponent story={story} /> ]
